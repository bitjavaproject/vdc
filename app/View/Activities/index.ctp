...
?>
<div class="row activities index">
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i><?php echo __('Activities'); ?>                </div>
                <div class="tools">
                ...
                <div class="actions">
                    <?php echo $this->Html->link(__('New Activity'), array('action' => 'add'), array('class' => 'btn purple')); ?>                </div>                    
            </div>
	...
	<tr>
		...
		<th class="actions">
			<?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-share')) . ' ' . __('View'), array('action' => 'view', $activity['Activity']['id']), array('class' => 'btn default btn-xs green', 'escape' => false)); ?>
			<?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-edit')) . ' ' . __('Edit'), array('action' => 'edit', $activity['Activity']['id']), array('class' => 'btn default btn-xs blue', 'escape' => false)); ?>
			<?php echo $this->Form->postLink($this->Html->tag('i', '', array('class' => 'fa fa-trash-o')) . ' ' . __('Delete'), array('action' => 'delete', $activity['Activity']['id']), array('class' => 'btn default btn-xs grey', 'escape' => false), __('Are you sure you want to delete # %s?', $activity['Activity']['id'])); ?>
		</th>
	</tr>
<?php endforeach; ?>
                        </tbody>
