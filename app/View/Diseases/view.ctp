...
<div class="row diseases">
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i><?php echo __('Disease'); ?>				</div>
				<div class="tools">
					<a class="collapse" href="javascript:;"> </a>
					<a class="reload" href="javascript:;"> </a>
				</div>
                <div class="actions">
                    <?php echo $this->Html->link(__('Edit Disease'), array('action' => 'edit', $disease['Disease']['id']), array('class' => 'btn purple')); ?>                </div>                    
			</div>
	...
	<tr>
		...
		<td>
			<?php echo h($disease['Disease']['modified_by']); ?>
			&nbsp;
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php echo h($disease['Disease']['updated']); ?>
			&nbsp;
		</td>
	</tr>
					</tbody>
