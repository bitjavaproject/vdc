    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i><?php echo __('Edit Family Agriculture Info'); ?>                </div>
                <div class="tools">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FamilyAgricultureInfo.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('FamilyAgricultureInfo.id'))); ?></li>
