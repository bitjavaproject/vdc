<div class="row familyLoanInfos form">
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i><?php echo __('Edit Family Loan Info'); ?>                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <?php echo $this->Form->create('FamilyLoanInfo', array('class' => 'form-horizontal', 
...
<div class='form-group'>
	<label class='col-md-3 control-label'>loan_source_id</label>
	<div class='col-md-4'>
		<?php echo $this->Form->input('loan_source_id'); ?>
	</div>
</div>
<div class='form-group'>
	<label class='col-md-3 control-label'>loan_objective</label>
	<div class='col-md-4'>
		<?php echo $this->Form->input('loan_objective'); ?>
	</div>
</div>
<div class='form-group'>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FamilyLoanInfo.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('FamilyLoanInfo.id'))); ?></li>
