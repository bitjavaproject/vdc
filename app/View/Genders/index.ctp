...
<div class="row genders index">
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i><?php echo __('Genders'); ?>                </div>
                <div class="tools">
                ...
                <div class="actions">
                    <?php echo $this->Html->link(__('New Gender'), array('action' => 'add'), array('class' => 'btn purple')); ?>                </div>                    
            </div>
                        ...
                        <thead>
                            <tr>
                                <th class="col-md-1"> # </th>
                                                                ...
                                                                <th class="col-md-2"> <?php echo $this->Paginator->sort('code'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($gender['Gender']['updated']); ?>&nbsp;</td>
		<td><?php echo h($gender['Gender']['code']); ?>&nbsp;</td>
		<th class="actions">
			<?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-share')) . ' ' . __('View'), array('action' => 'view', $gender['Gender']['id']), array('class' => 'btn default btn-xs green', 'escape' => false)); ?>
			<?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-edit')) . ' ' . __('Edit'), array('action' => 'edit', $gender['Gender']['id']), array('class' => 'btn default btn-xs blue', 'escape' => false)); ?>
			<?php echo $this->Form->postLink($this->Html->tag('i', '', array('class' => 'fa fa-trash-o')) . ' ' . __('Delete'), array('action' => 'delete', $gender['Gender']['id']), array('class' => 'btn default btn-xs grey', 'escape' => false), __('Are you sure you want to delete # %s?', $gender['Gender']['id'])); ?>
		</th>
	</tr>
<?php endforeach; ?>
                        </tbody>
