...
<head>
	...
	<?php
		...
		//echo $this->Html->css('http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all');
		 ...
		 echo $this->Html->script('../plugins/libraryhome/js/main');
	      echo $this->Html->css('../plugins/libraryhome/css/main');
		  echo $this->Html->css('../plugins/libraryhome/css/reset');
		  //echo $this->Html->css('handmade');
