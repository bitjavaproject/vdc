var UITree = function () {
    ...
    var handleSample1 = function () {
        ...
        function edit(data, nodeId){
        	//host_url+'grade_exam_setups/add'
        	$.fancybox.open({
			    'helpers'		:  {
			        'overlay' : {
			            'closeClick': false
				...
				'closeBtn'		: true,
				'href'			: host_url + 'grade_exam_setups/edit/'+nodeId, 
				'type'			: 'ajax',
			    'autoSize'		: false,
				'width'         : 600,
				'height'        : 'auto',
        ...
        function delete_setup(data, nodeId){
        	if (confirm('Are you sure you want to delete ?')) {
        		$.ajax({
            		type : 'POST',
            		url : host_url + 'grade_exam_setups/delete/'+nodeId,
            		success : function(response){
            			var obj = $.parseJSON(response);
                        alert(obj.msg);
                        window.location.href = host_url + 'grade_exam_setups/index/';
            		}
            	});
    		}
